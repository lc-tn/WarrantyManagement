...
namespace WarrantyManagement.Migrations
{
    ...
    [Migration("20240329025244_reason_warrantDeviceHistory")]
    partial class reason_warrantDeviceHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WarrantyRepository.Entities.DeviceHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WarrantyManagement.Entities.Device", b =>
                {
                    b.HasOne("WarrantyRepository.Entities.Category", "Category")
                        .WithMany("Devices")
